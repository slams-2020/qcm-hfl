...
class Qcm{
	...
	*/
	...
	/**
	 * @manyToOne
	 * @joinColumn("className"=>"models\\qcm\\Exam","name"=>"idExam","nullable"=>false)
	*/
	private $exam;

	/**
	 * @oneToMany("mappedBy"=>"qcm","className"=>"models\\qcm\\Useranswer")
	*/
	private $useranswers;
	...
	*/
	...
	/**
	 * @manyToMany("targetEntity"=>"models\\qcm\\Question","inversedBy"=>"qcms")
