...
class Exam{
	...
	*/
	...
	/**
	 * @oneToMany("mappedBy"=>"exam","className"=>"models\\qcmtest\\Examoption")
	*/
	private $examoptions;

	/**
	 * @oneToMany("mappedBy"=>"exam","className"=>"models\\qcmtest\\Qcm")
	*/
	private $qcms;

	/**
	 * @manyToOne
	 * @joinColumn("className"=>"models\\qcmtest\\Group","name"=>"idGroup","nullable"=>false)
	*/
	private $group;
