...
class Qcm{
	...
	*/
	...
	/**
	 * @manyToOne
	 * @joinColumn("className"=>"models\\qcmtest\\Exam","name"=>"idExam","nullable"=>false)
	*/
	private $exam;

	/**
	 * @oneToMany("mappedBy"=>"qcm","className"=>"models\\qcmtest\\Useranswer")
	*/
	private $useranswers;
	...
	*/
	...
	/**
	 * @manyToMany("targetEntity"=>"models\\qcmtest\\Question","inversedBy"=>"qcms")
