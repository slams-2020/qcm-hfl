...
class User{
	...
	*/
	...
	/**
	 * @oneToMany("mappedBy"=>"user","className"=>"models\\qcmtest\\Group")
	*/
	private $groups;

	/**
	 * @oneToMany("mappedBy"=>"user","className"=>"models\\qcmtest\\Qcm")
	*/
	private $qcms;

	/**
	 * @oneToMany("mappedBy"=>"user","className"=>"models\\qcmtest\\Question")
	*/
	private $questions;

	/**
	 * @oneToMany("mappedBy"=>"user","className"=>"models\\qcmtest\\Tag")
	*/
	private $tags;

	/**
	 * @oneToMany("mappedBy"=>"user","className"=>"models\\qcmtest\\Useranswer")
	*/
	private $useranswers;

	/**
	 * @manyToMany("targetEntity"=>"models\\qcmtest\\Group","inversedBy"=>"users")
